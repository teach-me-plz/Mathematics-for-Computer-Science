...
$a | b$는 어떤 정수 $k$에 있어서 $a \cdot k = b$ 일 때 성립한다.   
이는 다른 말로 " $a$가 $b$를 나눈다 ", " $b$는 $a$의 배수 " 라고도 한다.   
...
$gcd$를 구하고자 한다면 나머지를 계속 계산해 나가면 된다.   

![alt text](../images/유클리드알고리즘.png)

이로서 $\gcd(1147, 899)$ ($1147$과 $899$의 최대공약수)는 나머지인 $31$ 이다.   
...
항상 gcd(a, b)를 다음과 같은 선형 결합으로 표현할 수 있다고 한다면...   
...
이번에는 $\gcd$대신 $1147$과 $899$를 분해기에 넣어보자.   
...
확장 유클리드에서는 각 단계에서 다음과 같은 관계를 유지한다:

$$
r_i = r_{i-2} - q_{i-1} \cdot r_{i-1}
$$

각 $r_i$에 대응하는 $s_i, t_i$를 추적하면서, 선형 결합:

$$
r_i = s_i \cdot 1147 + t_i \cdot 899
$$

를 만족시키는 $s_i$, $t_i$를 구해가면 된다.

한번 이 표를 채워보자!

| i | 나머지 $r_i$ | 몫 $q_i$ | $s_i$ | $t_i$ | 선형 결합 |
|:-:|:-----------:|:--------:|:-----:|:-----:|:--------:|
| 0 |   1147      |         |  1   |  0   | $1 \cdot 1147 + 0 \cdot 899 = 1147$ |
| 1 |   899       |         |  0   |  1   | $0 \cdot 1147 + 1 \cdot 899 = 899$ |
| 2 |   248       |   1     |  1   |  -1  | $1 \cdot 1147 - 1 \cdot 899 = 248$ |
| 3 |   155       |   ?     |  ?   |  ?   | $?$      |
| 4 |   93        |   ?     |  ?   |  ?   | $?$      |
| 5 |   62        |   ?     |  ?   |  ?   | $?$      |
| 6 |   31        |   ?     |  ?   |  ?   | $?$      |

다음은 초기에 주어지는 두 항을 풀어낸 것이다.   
...
$$q = \left\lfloor \frac{1147}{899} \right\rfloor = 1$$

$$r_2 = 1147 - 1×899 = 248$$

$$s_2 = s_0 - q×s_1 = 1 - 1×0 = 1,\quad t_2 = t_0 - q×t_1 = 0 - 1×1 = -1$$
...
$$q = \left\lfloor \frac{899}{248} \right\rfloor = 3$$

$$r_3 = 899 - 3×248 = 155$$

$$s_3 = s_1 - 3×s_2 = 0 - 3×1 = -3,\quad t_3 = t_1 - 3×t_2 = 1 - 3×(-1) = 4$$

| 3 | 155 | 3 | -3 | 4 | $-3 \cdot 1147 + 4 \cdot 899 = 155$ |
|:-:|:-:|:-:|:-:|:-:|:-:|
...
$$q = \left\lfloor \frac{248}{155} \right\rfloor = 1$$

$$r_4 = 248 - 1×155 = 93$$

$$s_4 = s_2 - 1×s_3 = 1 - (-3) = 4,\quad t_4 = t_2 - 1×t_3 = -1 - 4 = -5$$

| 4 | 93 | 1 | 4 | -5 | $4 \cdot 1147 - 5 \cdot 899 = 93$ |
|:-:|:-:|:-:|:-:|:-:|:-:|
...
$$q = \left\lfloor \frac{155}{93} \right\rfloor = 1$$

$$r_5 = 155 - 1×93 = 62$$

$$s_5 = s_3 - 1×s_4 = -3 - 4 = -7,\quad t_5 = t_3 - 1×t_4 = 4 - (-5) = 9$$

| 5 | 62 | 1 | -7 | 9 | $-7 \cdot 1147 + 9 \cdot 899 = 62$ |
|:-:|:-:|:-:|:-:|:-:|:-:|
...
$$q = \left\lfloor \frac{93}{62} \right\rfloor = 1$$

$$r_6 = 93 - 1×62 = 31$$

$$s_6 = s_4 - 1×s_5 = 4 - (-7) = 11,\quad t_6 = t_4 - 1×t_5 = -5 - 9 = -14$$

| 6 | 31 | 1 | 11 | -14 | $11 \cdot 1147 - 14 \cdot 899 = 31$ |
|:-:|:-:|:-:|:-:|:-:|:-:|
...
$$q = \left\lfloor \frac{62}{31} \right\rfloor = 2$$

$$r_7 = 62 - 2×31 = 0$$

이제 종료! $\gcd(1147, 899) = 31$,
그리고 선형결합:

$$
31 = 1147 \cdot 11 + 899 \cdot (-14)
$$
...
| 나머지  | 몫 | $s$ | $t$ | 선형 결합                             |
|:----:|:-:|:---:|:---:|:--------------------------------------:|
| 1147 |   | 1   | 0   | $1147 \cdot 1 + 899 \cdot 0 = 1147$    |
| 899  |   | 0   | 1   | $1147 \cdot 0 + 899 \cdot 1 = 899$     |
| 248  | 1 | 1   | -1  | $1147 \cdot 1 + 899 \cdot (-1) = 248$  |
| 155  | 3 | -3  | 4   | $1147 \cdot (-3) + 899 \cdot 4 = 155$  |
| 93   | 1 | 4   | -5  | $1147 \cdot 4 + 899 \cdot (-5) = 93$   |
| 62   | 1 | -7  | 9   | $1147 \cdot (-7) + 899 \cdot 9 = 62$   |
| 31   | 1 | 11  | -14 | $1147 \cdot 11 + 899 \cdot (-14) = 31$ |
...
$$a = q_1 \cdot n + r_1, \quad 0 \le r_1 < n$$
$$b = q_2 \cdot n + r_2, \quad 0 \le r_2 < n$$

이 둘을 빼면:   
$$a - b = (q1 - q2) \cdot n + (r_1 - r_2)$$
